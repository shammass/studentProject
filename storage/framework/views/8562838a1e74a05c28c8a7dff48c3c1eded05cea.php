   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			<?php endif; ?>
            <div class="col-lg-12">
			<?php echo Form::model($fetchPackageDetails, ['method' => 'PATCH', 'id'=>'form-validation', 'name'=>'form-validation', 'route' => ['updatePackage', $fetchPackageDetails->package_id], 'enctype'=>'multipart/form-data']); ?>

				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-blogname">Package Name  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-blogname" class="form-control"  placeholder="Package Name" value="<?php echo e($fetchPackageDetails->package_name); ?>"   name="name"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Package Name must not be empty!">
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-blogname">Package Validity  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-blogname" class="form-control"  placeholder="Package Validity"   name="validity"  type="text" value="<?php echo e($fetchPackageDetails->validity); ?>" data-validation="[NOTEMPTY]" data-validation-message="Package Validity must not be empty!">
                        </div>
                   <!--  <div class="col-lg-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php echo Form::file('blog_image', array('class' => 'image', 'data-validation'=>'[NOTEMPTY]', 'data-validation-message'=>'Blog Image must not be empty!')); ?>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('viewPackages')); ?>"  class="btn btn-default">Cancel</a>
                </div>
			<?php echo Form::close(); ?>
