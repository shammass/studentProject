<?php $__env->startSection('title', 'Send Service Request'); ?>
   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			<?php endif; ?>
            <div class="col-lg-12">
			 <?php echo Form::open(array('route' => 'storeServiceRequest','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')); ?>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('viewServicesForCustomer')); ?>"  class="btn btn-default">Cancel</a>
                </div>
			<?php echo Form::close(); ?>
