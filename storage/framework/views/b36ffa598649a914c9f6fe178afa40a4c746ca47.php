   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			<?php endif; ?>
            <div class="col-lg-12">
			 <?php echo Form::open(array('route' => 'storeService','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')); ?>

				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-blogname">Service Name  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-blogname" class="form-control"  placeholder="Service Name"   name="service"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Service Name must not be empty!">
                        </div>
                    </div>
                   <!--  <div class="col-lg-6">
                        <div class="form-group">
