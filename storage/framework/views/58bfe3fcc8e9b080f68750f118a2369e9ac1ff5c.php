<?php $__env->startSection('title', 'Manage Blog'); ?>
	...
	<div class="card-body">
        ...
        <table class="table table-hover nowrap" id="example1" width="100%">
            ...
            <tr>
                ...
                <td><?php echo e($blog->blogcategory_name); ?></td>
                <td><?php echo e($blog->blog_brief_description); ?></td>
                <td><img src="<?php echo asset("/upload/blogimage/$blog->blog_image") ?>" style="width:90px;"></td>
               <td style="width:250px;">
                    <a href="" class="btn btn-primary" style="margin-left:40px;"> Edit</a>
