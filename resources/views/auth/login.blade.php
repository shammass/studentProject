                    ...
                    <div class="cat__pages__login__block__form">
						...
						{{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    Register as Service Provider : <a href="{{ url('/register/service_provider') }}" class=" cat__core__link--blue cat__core__link--underlined">Service Provider Registration</a>
                                </div>
                                <div class="checkbox">
                                    Register as Customer : <a href="{{ url('/register/customer') }}" class="cat__core__link--blue cat__core__link--underlined">Customer Registration</a>
                                </div>
                            </div>
